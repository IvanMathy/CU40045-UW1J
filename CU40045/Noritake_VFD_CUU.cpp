...
void Noritake_VFD_CUU::CUU_init()
{
	io->init();
...
void Noritake_VFD_CUU::CUU_command(uint8_t data)
{
	io->write(data, false, currentModule);
	_delay_us(MIN_DELAY);
}
...
//data: byte to send
void Noritake_VFD_CUU::CUU_writeData(uint8_t data)
{
	io->write(data, true, currentModule);
	_delay_us(MIN_DELAY);
}
...
{
	uint8_t data = io->read(false, currentModule);
	_delay_us(MIN_DELAY);
	return data;
}
...
void Noritake_VFD_CUU::nextLine()
{
...
void Noritake_VFD_CUU::print(char data)
{
	CUU_writeData(data);
}
...
void Noritake_VFD_CUU::print(const char *str)
{
	while (*str)
		print(*str++);
}
...
void Noritake_VFD_CUU::print(const uint8_t *buffer, size_t size)
{
	while (size--)
		print((char)*buffer++);
}
...
//The effects of printing past the end of the line depends on the model.
//data:	character to print
void Noritake_VFD_CUU::println(char data)
{
	print(data);
	nextLine();
}
...
//The effects of printing past the end of the line depends on the model.
//str: a null-terminated string
void Noritake_VFD_CUU::println(const char *str)
{
	print(str);
	nextLine();
}
...
//buffer:	characters to print
//size:	number of characters to print
void Noritake_VFD_CUU::println(const uint8_t *buffer, size_t size)
{
	print(buffer, size);
	nextLine();
}

void Noritake_VFD_CUU::printNumber(unsigned long number, int base)
{
	if (number / base)
...
void Noritake_VFD_CUU::printNumber(long number, int base)
{
	if (number / base)
		printNumber(number / base, base);
	print("0123456789ABCDEF"[number % base]);
...
void Noritake_VFD_CUU::print(int number, int base)
{
	if (number < 0)
	{
		print('-');
...
//number:	number to print
//base:	base to print in (2-16)
void Noritake_VFD_CUU::print(unsigned int number, int base)
{
...
//number:	number to print
//base:	base to print in (2-16)
void Noritake_VFD_CUU::print(long number, int base)
{
	if (number < 0)
	{
		print('-');
...
//number:	number to print
//base:	base to print in (2-16)
void Noritake_VFD_CUU::print(unsigned long number, int base)
{
...
//number:	number to print
//base:	base to print in (2-16)
void Noritake_VFD_CUU::println(int number, int base)
{
...
//number:	number to print
//base:	base to print in (2-16)
void Noritake_VFD_CUU::println(unsigned int number, int base)
{
...
//number:	number to print
//base:	base to print in (2-16)
void Noritake_VFD_CUU::println(long number, int base)
{
	print(number, base);
	nextLine();
}
...
//number:	number to print
//base:	base to print in (2-16)
void Noritake_VFD_CUU::println(unsigned long number, int base)
{
	print(number, base);
	nextLine();
}
...
// left-to-right.
void Noritake_VFD_CUU::CUU_clearScreen()
{
	CUU_command(0x01);
	_delay_ms(5);
}
...
void Noritake_VFD_CUU::CUU_home()
{
...
void Noritake_VFD_CUU::CUU_setCursor(uint8_t pos)
{
...
void Noritake_VFD_CUU::CUU_setCursor(uint8_t col, uint8_t line)
{
...
void Noritake_VFD_CUU::setDisplay()
{
...
// ----------------------------------------------------------------
// Turn the display on.
void Noritake_VFD_CUU::CUU_displayOn()
{
	display = true;
	setDisplay();
}
...
void Noritake_VFD_CUU::CUU_displayOff()
{
	display = false;
	setDisplay();
}
...
void Noritake_VFD_CUU::CUU_cursorOn()
{
	cursor = true;
	setDisplay();
}
...
void Noritake_VFD_CUU::CUU_cursorOff()
{
	cursor = false;
	setDisplay();
}
...
void Noritake_VFD_CUU::CUU_blinkOn()
{
	blink = true;
	setDisplay();
}
...
void Noritake_VFD_CUU::CUU_blinkOff()
{
	blink = false;
	setDisplay();
}
...
void Noritake_VFD_CUU::CUU_scrollDisplayLeft()
{
	CUU_command(0x18);
	_delay_us(MIN_DELAY);
}
...
void Noritake_VFD_CUU::CUU_scrollDisplayRight()
{
	CUU_command(0x1c);
	_delay_us(MIN_DELAY);
}

void Noritake_VFD_CUU::setDirection()
{
...
void Noritake_VFD_CUU::CUU_leftToRight()
{
	rightToLeft = false;
	setDirection();
}
...
// character has been inserted.
void Noritake_VFD_CUU::CUU_rightToLeft()
{
	rightToLeft = true;
	setDirection();
}
...
void Noritake_VFD_CUU::CUU_autoscroll()
{
	autoscroll = true;
	setDirection();
}
...
// printed.
void Noritake_VFD_CUU::CUU_noAutoscroll()
{
	autoscroll = false;
	setDirection();
}
...
//	CU20045-UW7J, CU20049-UW2J, CU20049-UW2A
void Noritake_VFD_CUU::CUU_createChar(uint8_t num, uint8_t *bits)
{
	if (num >= 8)
		return;
...
//	The fifth bit of the eighth byte sets the whole row if set.
//	Other bits in the eighth byte are ignored.
void Noritake_VFD_CUU::CUU_readChar(uint8_t *data, uint8_t num)
{
	if (num >= 8)
		return;
...
//		CU16025-UX6A
//		CU20025-UX1J
void Noritake_VFD_CUU::CUU_brightness(int brightness)
{
	if (bc_vfd)
	{
	...
	{
		const register int m = 1;
		if (brightness <= 0 || brightness > 100 * m)
			return;
